...
function IconShare() {
  return <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M5 4h14v14H5z"/><path d="M12 8l5-5"/><path d="M17 3v5h-5"/></svg>;
}
function IconMore() {
