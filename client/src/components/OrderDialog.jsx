...
export default function OrderDialog({ orderDlg, personnel, onClose, onSaved, mode = 'modal' }) {
  ...
  if (isPage) {
    return (
      <div style={{ minHeight: '100vh', background: '#F7F7F7', paddingBottom: 'calc(12px + env(safe-area-inset-bottom))' }}>
        <div style={{ position: 'sticky', top: 0, zIndex: 50, height: 48, background: '#fff', borderBottom: '1px solid #EFEFEF', display: 'flex', alignItems: 'center', padding: '0 12px' }}>
          <button type="button" onClick={requestClose} style={{ background: 'none', border: 'none', padding: 6, color: '#1f2329' }}>
          ...
          <div style={{ flex: 1, textAlign: 'center', fontSize: 16, color: '#1f2329' }}>新增订单</div>
          <div style={{ width: 34 }} />
        </div>
