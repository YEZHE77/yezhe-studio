...
// 服务协议默认文案（服务内容 + 费用 + 权利义务 + 违约责任）
export const DEFAULT_SERVICE_AGREEMENT = [
  '一、服务内容',
  '1. 拍摄项目：婚礼全程跟拍（单机位 / 多机位），以新娘早妆为开始，晚宴仪式结束。',
  '2. 拍摄成果交付：拍摄底片（张数以订单为准）、后期调色精修处理、后期精修照片制作电子相册。',
  '3. 交付时间：婚礼预告片 9-15 张精修（1-7 天内交付，赠送服务）；全部成片婚礼后 30 日内交付。',
  '4. 特别说明：赠送婚礼预告服务，预告张数纳入套餐正片精修图计算；自选精修片请提前告知摄影师（自选精修片则无婚礼预告片服务）。',
  '',
  '二、服务费用及支付方式',
  '1. 总费用、定金、尾款均以订单为准。',
