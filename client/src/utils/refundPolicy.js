...
export const POLICY_TEXTS = {
  ...
  // 「严格」档 = 叶哲工作室官方退订、改期与违约责任模板（2026-08-15 用户提供）
  '严格': [
    '定金履约规则：客户支付定金后正式锁定当日摄影师档期，若甲方单方面主动取消婚礼拍摄，定金不予退还；仅因疫情管控、政府限制、重大自然灾害等不可抗力导致婚礼无法举办，可免费协商改期，定金保留有效。',
    '尾款交付约束：婚礼拍摄结束 24 小时内甲方需结清全部尾款，逾期未结清的，乙方有权暂停交付底片、精修、婚礼预告、电子相册等全部影像素材，直至全款结清。',
    '临时缺席处理：婚礼当日甲方无故不到场、临时放弃拍摄，属于甲方单方违约，所有已支付定金、拍摄费用不予退还。',
    '改期规则：甲方如需变更拍摄日期，需提前与乙方沟通确认，仅摄影师存在空余档期时可重新安排，无强制免费改期次数，改期产生的异地差旅等额外费用由甲方承担。',
    '乙方违约处理：摄影师无不可抗力因素无法到场完成拍摄，全额退还客户已支付定金、尾款全部费用；若因设备、存储问题造成影像素材丢失，双方友好协商退款补偿，补偿上限为本订单总服务金额。',
    '争议处理：因取消、改期、退款产生纠纷，双方优先协商，协商不成向乙方所在地人民法院提起诉讼。'
  ].join('\n')
};
